...
<template>
  ...
  <div class="swiper-wrap">
    ...
    <div class="allImg-wrap" :style='slideEffect' >
      <div class="img-wrap" ref="imgWrap" @click="onClick" @touchstart='touchStart' @touchmove='touchMove' @touchend='touchEnd' value='1'>
       <img src="http://img05.tooopen.com/images/20150820/tooopen_sy_139205349641.jpg" alt="1" data-index="1">
      </div>
